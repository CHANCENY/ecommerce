        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-md-6 col-lg-4 order-lg-1 order-2">
                    <!-- img -->
                    <img src="/themes/shop/assets/images/svg-graphics/fp-g.svg" alt="" class="img-fluid">
                </div>
                        ...
                        <form method="post" class="needs-validation" novalidate="">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" name="email_address" class="form-control" id="formForgetEmail" placeholder="Email" required="">
                                    <div class="invalid-feedback">Please enter correct password.</div>
                                </div>

                                <!-- btn -->
                                <div class="col-12 d-grid gap-2">
                                    <button type="submit" name="email" class="btn btn-primary">Reset Password</button>
                                    <a href="/user/login" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
