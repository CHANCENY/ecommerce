        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-lg-2 col-lg-8 col-12">
                    <div class="mb-8">
                        <!-- heading -->
                        <h1 class="h3">Partnership Request</h1>
                        <p class="lead mb-0">This form is for partnership requesting only. For all other customer or shopper support requests, please visit the links below this form.</p>
                    </div>
                    <!-- form -->
