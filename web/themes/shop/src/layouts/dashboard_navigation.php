...
/**@var $user \Mini\Cms\Modules\CurrentUser\CurrentUser **/
$user = $current_user;

$site = new \Mini\Cms\Modules\Site\Site();
$logo = $site->getBrandingAssets('Logo')['fid'] ?? null;
if($logo) {
    $logo = \Mini\Cms\Modules\FileSystem\File::load($logo);
    $logo = '/'. $logo->getFilePath();
}
$user_profile = '/'. (new \Mini\Cms\Modules\Streams\MiniWrapper())->getRealPath($user->getImage());
?>
<div>
    <!-- navbar -->
                    ...
                    <ul class="list-unstyled d-flex align-items-center mb-0 ms-5 ms-lg-0">
                        ...
                        <li class="dropdown ms-4">
                            <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?= $user_profile; ?>" alt="" class="avatar avatar-md rounded-circle">
                            </a>

                            <div class="dropdown-menu dropdown-menu-end p-0">
                                <div class="lh-1 px-5 py-4 border-bottom">
                                    <h5 class="mb-1 h6"><?= $user->getAccountName(); ?></h5>
                                    <small><?= $user->getAccountEmail(); ?></small>
                                </div>
            ...
            <div class="navbar-vertical">
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        <li class="nav-item">
                            <a class="nav-link  active " href="/shop/dashboard">
                                <div class="d-flex align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="/shop/categories">
                                <div class="d-flex align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="/shop/vendors">
                                <div class="d-flex align-items-center">
