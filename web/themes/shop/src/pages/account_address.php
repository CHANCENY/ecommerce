            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    <div class="py-6 p-md-6 p-lg-10">
                        ...
                        <div class="row">
                            <?php foreach ($content['address'] as $address): if($address instanceof \Mini\Cms\Modules\Modal\RecordCollection): ?>
                            <!-- col -->
                                ...
                                <div class="card">
                                    <div class="card-body p-6">
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault" data="<?= $address->address_id ?>" id="<?php $address->address_type === 'home' ? 'homeRadio' : 'workRadio'; ?>" checked="">
                                            <label class="form-check-label text-dark fw-semibold" for="homeRadio"><?= $address->address_type; ?></label>
                                        </div>
                                        <!-- address -->
                                        <p class="mb-6">
                                            ...
                                            <br>
                                            <?php
                                               $add = $content['modal']?->address($address->address_field_id);
                                            ?>

                                            <?= $add['zip_code'].' '.$add['address_1'].','; ?>
                                            <br>

                                            <?= $add['state_name']. ', '.$add['country_name'] ?>
                                            <br>
